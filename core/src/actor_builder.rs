...
//DO NOT rename this actor_builder module, the backtrace logic uses this name to shorten traces.
...
impl ActorTeam {
    ...
    fn add_actor<F, I>(&mut self, mut actor_startup_receiver: Option<Receiver<()>>
                       , context_archetype: SteadyContextArchetype<I>
                       , frame_rate_ms: u64)
